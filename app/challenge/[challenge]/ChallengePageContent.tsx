      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          ...
          >
            ...
            {challenge.category.toLowerCase()} concepts and improve your skills
            in {challenge.skills.slice(0, 3).join(', ')}.
          </motion.p>
          <motion.div
        ...
        {relatedChallenges.length > 0 && (
          ...
          >
            ...
            >
              Ready for more? Try these challenges that share similar skills and
              concepts.
            </motion.p>
            <div className="grid md:grid-cols-2 gap-6">
              {relatedChallenges.map(
                (relatedChallenge: Challenge, index: number) => (
                  <motion.div
